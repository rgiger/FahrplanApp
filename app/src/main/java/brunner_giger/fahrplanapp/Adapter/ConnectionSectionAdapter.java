...
public class ConnectionSectionAdapter extends ArrayAdapter<ConnectionSection>  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.tvdetProgDep)).setText(connectionSection.DeparturePrognosis);
        ...
        ((TextView) convertView.findViewById(R.id.tvdetProgArr)).setText(connectionSection.ArrivalPrognosis);
